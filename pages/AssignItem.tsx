...
import { Search, Home, AlertTriangle, ArrowLeft, Save, FileText } from 'lucide-react';
        ...
        <div className="p-4">
           ...
           {item && (
             <div className="space-y-2 animation-fade-in">
                {confirmUnassign && (
                    <div className="p-2 bg-yellow-50 border border-yellow-300 text-yellow-800 dark:bg-yellow-900/30 dark:border-yellow-800 dark:text-yellow-300 rounded flex items-center gap-2 text-sm">
